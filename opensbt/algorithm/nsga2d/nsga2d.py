...
from opensbt.algorithm.nsga2d.archive import ProcessingMode, SmartArchiveInput
...
class NSGA2D(GeneticAlgorithm):
    ...
    def __init__(self,
                 ...
                 n_repopulate_max=0,
                 archive_threshold = 1,
                 mode_processing: ProcessingMode = ProcessingMode.SEQUENTIAL,
        ...
        # self.archive_optimal = Population()  # we store here the optimal solutions
        self.archive_novelty = SmartArchiveInput(archive_threshold)    
        self.mode_processing = mode_processing
    ...
    def _initialize_advance(self, infills=None, **kwargs):
        ...
        self.archive_novelty.process_population(self.pop, self.mode_processing)
    ...
    def _advance(self, infills=None, **kwargs):
        ...
        # print(infills.get("F"))
        self.archive_novelty.process_population(pop, self.mode_processing)
